 ...
 * @author viet6
 */
public class ThanhToanHoaDon_GUI extends javax.swing.JFrame {
...
//ho ten
            ...
            public void run() {
                while (true) {
                    try {
                        ...
                        Logger.getLogger(ThanhToanHoaDon_GUI.class.getName()).log(Level.SEVERE, null, ex);
                    }
                    Date date = new Date();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ThanhToanHoaDon_GUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ThanhToanHoaDon_GUI().setVisible(true);
            }
        });
    }
